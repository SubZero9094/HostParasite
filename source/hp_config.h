...
EMP_BUILD_CONFIG( HPConfig,
  ...
  VALUE(GRA_DIM,  size_t,       2, "Dimension of graph"),
  ...
  VALUE(MIN_FUN_CNT, size_t,   2, "Minimum number of functions each hardware should have."),
  ...
  VALUE(POP_SIZE,  size_t, 30000, "Population size."),
  VALUE(NUM_GENS,  size_t, 1000, "Number of generations per experiments."),
